...
template
class BwVColumnIterator<1>;

template
class BwVColumnIterator<2>;

template
class BwVColumnIterator<3>;

template
class BwVColumnIterator<4>;

template
class BwVColumnIterator<5>;

template
class BwVColumnIterator<6>;

template
class BwVColumnIterator<7>;

template
class BwVColumnIterator<8>;

template
class BwVColumnIterator<9>;

template
class BwVColumnIterator<10>;

template
class BwVColumnIterator<11>;

template
class BwVColumnIterator<12>;

template
class BwVColumnIterator<13>;

template
class BwVColumnIterator<14>;

template
class BwVColumnIterator<15>;

template
class BwVColumnIterator<16>;

template
class BwVColumnIterator<17>;

template
class BwVColumnIterator<18>;

template
class BwVColumnIterator<19>;

template
class BwVColumnIterator<20>;

template
class BwVColumnIterator<21>;

template
class BwVColumnIterator<22>;

template
class BwVColumnIterator<23>;

template
class BwVColumnIterator<24>;

template
class BwVColumnIterator<25>;

template
class BwVColumnIterator<26>;

template
class BwVColumnIterator<27>;

template
class BwVColumnIterator<28>;

template
class BwVColumnIterator<29>;

template
class BwVColumnIterator<30>;

template
class BwVColumnIterator<31>;

template
class BwVColumnIterator<32>;
